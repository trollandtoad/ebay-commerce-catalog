...
use eBay\Commerce\Catalog\ApiException;
use eBay\Commerce\Catalog\Configuration;
use eBay\Commerce\Catalog\HeaderSelector;
...
class ProductSummaryApi
{
     ...
     *
     * @throws \eBay\Commerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \eBay\Commerce\Catalog\Model\ProductSearchResponse
     */
     ...
     * @throws \eBay\Commerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \eBay\Commerce\Catalog\Model\ProductSearchResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($aspect_filter = null, $category_ids = null, $fieldgroups = null, $gtin = null, $limit = null, $mpn = null, $offset = null, $q = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eBay\Commerce\Catalog\Model\ProductSearchResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eBay\Commerce\Catalog\Model\ProductSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\eBay\Commerce\Catalog\Model\ProductSearchResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\eBay\Commerce\Catalog\Model\ProductSearchResponse',
