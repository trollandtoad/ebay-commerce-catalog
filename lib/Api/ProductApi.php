...
class ProductApi
{
     ...
     * @return \eBay\Commerce\Catalog\Model\Product
     */
     ...
     * @throws \eBay\Commerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \eBay\Commerce\Catalog\Model\Product, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductWithHttpInfo($epid)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eBay\Commerce\Catalog\Model\Product' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eBay\Commerce\Catalog\Model\Product', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\eBay\Commerce\Catalog\Model\Product';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\eBay\Commerce\Catalog\Model\Product',
