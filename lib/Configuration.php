...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.ebay.com/commerce/catalog/v1_beta';
    ...
    {
        $report  = 'PHP SDK (eBay\Commerce\Catalog) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v1_beta.5.0' . PHP_EOL;
            ...
            [
                ...
                "variables" => [
                    "basePath" => [
                        ...
                        "default_value" => "/commerce/catalog/v1_beta",
                    ]
                ]
            ]
        ];
